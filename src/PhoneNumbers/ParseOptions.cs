...
public sealed class ParseOptions
{
    ...
    internal CountryInfo? GetCountryInfo(string countryCode) =>
        Countries.SingleOrDefault(x => x.Iso3166Alpha2Code.Equals(countryCode, StringComparison.OrdinalIgnoreCase)
        || x.Iso3166Alpha3Code.Equals(countryCode, StringComparison.OrdinalIgnoreCase));
