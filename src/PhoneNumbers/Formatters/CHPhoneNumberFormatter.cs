namespace PhoneNumbers.Formatters
{
    ...
    internal sealed class CHPhoneNumberFormatter : PhoneNumberFormatter
    {
        ...
        protected override string FormatDisplay(PhoneNumber phoneNumber)
        {
            ...
            return $"{phoneNumber.CountryInfo.TrunkPrefix}{phoneNumber.AreaCode}{phoneNumber.LocalNumber.Substring(0, 1)} {phoneNumber.LocalNumber.Substring(1, 3)} {phoneNumber.LocalNumber.Substring(4)}";
        }
    }
}
