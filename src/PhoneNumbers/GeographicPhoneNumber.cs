...
public sealed class GeographicPhoneNumber : PhoneNumber, IEquatable<GeographicPhoneNumber>
{
    ...
    /// <summary>
    /// Determines whether two specified <see cref="GeographicPhoneNumber"/> objects are not equal.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether two specified <see cref="GeographicPhoneNumber"/> objects are equal.
    /// </summary>
    /// <param name="phoneNumber1">The first phone number to compare.</param>
    /// <param name="phoneNumber2">The second phone number to compare.</param>
