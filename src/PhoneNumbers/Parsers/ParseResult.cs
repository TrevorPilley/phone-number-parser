...
/// </summary>
internal sealed record ParseResult(string? ParseError, PhoneNumber? PhoneNumber)
{
    /// <summary>
    ...
    internal static ParseResult Failure(string parseError) =>
        new(parseError, PhoneNumber: null);
    ...
    internal static ParseResult Success(PhoneNumber phoneNumber) =>
        new(ParseError: null, PhoneNumber: phoneNumber);
