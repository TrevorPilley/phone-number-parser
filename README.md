...
- .NET 7.0
- .NET Standard 2.1 - _supports .NET Core 3.0 - 3.1 and .NET 5.0 - 6.0_
- .NET Standard 2.0 - _supports .NET Framework 4.6.2 - 4.8.x (.NET Framework projects will need to be built with C# 9.0 or later)_
...
- https://www.itu.int/dms_pub/itu-t/oth/02/02/T02020000A40009PDFE.pdf
