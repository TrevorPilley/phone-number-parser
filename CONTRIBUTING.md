...
The project multi targets .NET Standard 2.0 + 2.1 and .NET 5.0 + 6.0 so you will need to have the relevant SDK's installed in order to build the solution locally. It also uses some C# 10 language features so you will need an IDE that supports C# 10.
