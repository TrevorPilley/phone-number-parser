...
public class MobilePhoneNumberTests
{
    ...
    {
        var phoneNumber1 = new MobilePhoneNumber(PhoneNumberHint.None)
        {
    ...
    public void Equality_Same_Values_With_NationalDestinationCode()
    {
        ...
        var phoneNumber2 = new MobilePhoneNumber(PhoneNumberHint.None)
        {
            Country = CountryInfo.UnitedKingdom,
            NationalDestinationCode = "7654",
            NationalSignificantNumber = "7654112233",
    ...
    public void Equality_Same_Values_Without_NationalDestinationCode()
    {
        var phoneNumber1 = new MobilePhoneNumber(PhoneNumberHint.None)
        {
            ...
            NationalSignificantNumber = "112233",
            SubscriberNumber = "112233",
        };
        var phoneNumber2 = new MobilePhoneNumber(PhoneNumberHint.None)
        {
    ...
    public void Inequality()
    {
        ...
        {
            Country = CountryInfo.UnitedKingdom,
            NationalDestinationCode = "7655",
            NationalSignificantNumber = "7655112233",
            SubscriberNumber = "112233",
        };
        ...
        var phoneNumber4 = new MobilePhoneNumber(PhoneNumberHint.None)
        {
            Country = CountryInfo.UnitedKingdom,
            NationalDestinationCode = "7654",
            NationalSignificantNumber = "7654112234",
            SubscriberNumber = "112234",
        };
