...
public class PhoneNumber_ToString_Asia_Tests
{
    ...
    [Theory]
    [InlineData("+81352535863", "E.123", "+81 3 5253 5863")]
    [InlineData("+81117338801", "E.123", "+81 11 733 8801")]
    [InlineData("+81289606655", "E.123", "+81 289 60 6655")]
    [InlineData("+81352535863", "N", "(03) 5253 5863")]
    [InlineData("+81117338801", "N", "(011) 733 8801")]
    [InlineData("+81289606655", "N", "(0289) 60 6655")]
    [InlineData("+81352535863", "RFC3966", "tel:+81-3-5253-5863")]
    [InlineData("+81117338801", "RFC3966", "tel:+81-11-733-8801")]
    [InlineData("+81289606655", "RFC3966", "tel:+81-289-60-6655")]
    [InlineData("+81352535863", "U", "0352535863")]
    [InlineData("+81117338801", "U", "0117338801")]
    [InlineData("+81289606655", "U", "0289606655")]
    public void Japan_Numbers(string input, string format, string expected) =>
        Assert.Equal(expected, PhoneNumber.Parse(input).ToString(format));
