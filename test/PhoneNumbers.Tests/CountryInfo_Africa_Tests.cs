...
public class CountryInfo_Africa_Tests
{
    ...
    public void CountryInfo_Kenya()
    {
        ...
        Assert.Equal("KEN", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
    ...
    [Fact]
    public void CountryInfo_Mayotte()
    {
        Assert.Same(CountryInfo.Mayotte, CountryInfo.Mayotte);

        var countryInfo = CountryInfo.Mayotte;

        Assert.False(countryInfo.AllowsLocalGeographicDialling);
        Assert.Equal("262", countryInfo.CallingCode);
        Assert.Equal(CountryInfo.Africa, countryInfo.Continent);
        Assert.IsType<FodPhoneNumberFormatProvider>(countryInfo.FormatProvider);
        Assert.Equal("Mayotte", countryInfo.FullName);
        Assert.Equal(CountryInfo.ItuInternationalCallPrefix, countryInfo.InternationalCallPrefix);
        Assert.Empty(countryInfo.InternationalCallPrefixes);
        Assert.False(countryInfo.IsArabLeagueMember);
        ...
        Assert.Equal("MYT", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
    ...
    public void CountryInfo_Nigeria()
    {
        ...
        Assert.Equal("NGA", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
    ...
    public void CountryInfo_Reunion()
    {
        ...
        Assert.Equal("REU", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
    ...
    public void CountryInfo_SouthAfrica()
    {
        ...
        Assert.Equal("ZAF", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
    ...
    public void CountryInfo_Tanzania()
    {
        ...
        Assert.Equal("TZA", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
    ...
    public void CountryInfo_Uganda()
    {
        ...
        Assert.Equal("UGA", countryInfo.Iso3166Alpha3Code);
        Assert.False(countryInfo.IsOecdMember);
