...
namespace PhoneNumbers.Tests
{
    public class GeographicPhoneNumberTests
    {
        ...
        public void Constructor_Throws_If_GeographicArea_Null() =>
            Assert.Throws<ArgumentException>(() => new GeographicPhoneNumber(CountryInfo.UnitedKingdom, "12345", "667788", null));
        ...
        public void Inequality()
        {
            ...
            // Change area code
            var phoneNumber3 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, "12346", "667788", "N/A");
            ...
            // change local number
            var phoneNumber4 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, "12345", "667789", "N/A");
            ...
            var phoneNumber5 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, "12345", "667788", "N/B");
