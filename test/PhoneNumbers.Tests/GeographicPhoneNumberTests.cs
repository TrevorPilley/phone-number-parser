...
namespace PhoneNumbers.Tests
{
    public class GeographicPhoneNumberTests
    {
        ...
        public void Constructor_Sets_Properties()
        {
            ...
            var phoneNumber = new GeographicPhoneNumber(countryInfo, PhoneNumberHint.None, "12345", "667788", "N/A");
        ...
        public void Constructor_Throws_If_CountryInfo_Null() =>
            Assert.Throws<ArgumentNullException>(
                () => new GeographicPhoneNumber(null, PhoneNumberHint.None, "12345", "667788", "N/A"));

        [Fact]
        public void Constructor_Throws_If_GeographicArea_Empty() =>
            Assert.Throws<ArgumentException>(
                () => new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667788", ""));

        [Fact]
        public void Constructor_Throws_If_GeographicArea_Null() =>
            Assert.Throws<ArgumentException>(
                () => new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667788", null));
        ...
        public void Constructor_Throws_If_SubscriberNumber_Empty() =>
            Assert.Throws<ArgumentException>(
                () => new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "", "N/A"));

        [Fact]
        public void Constructor_Throws_If_SubscriberNumber_Null() =>
            Assert.Throws<ArgumentException>(
                () => new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", null, "N/A"));
        ...
        {
            var phoneNumber1 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667788", "N/A");
        ...
        {
            var phoneNumber1 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667788", "N/A");
            var phoneNumber2 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667788", "N/A");
        ...
        {
            var phoneNumber1 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, null, "667788", "N/A");
            var phoneNumber2 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, null, "667788", "N/A");
        ...
        public void Inequality()
        {
            ...
            // Change area code
            var phoneNumber3 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12346", "667788", "N/A");
            ...
            // change local number
            var phoneNumber4 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667789", "N/A");
            ...
            var phoneNumber5 = new GeographicPhoneNumber(CountryInfo.UnitedKingdom, PhoneNumberHint.None, "12345", "667788", "N/B");
