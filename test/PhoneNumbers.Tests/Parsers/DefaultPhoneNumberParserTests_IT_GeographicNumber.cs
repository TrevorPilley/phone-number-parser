...
namespace PhoneNumbers.Tests.Parsers
{
    ...
    public class DefaultPhoneNumberParserTests_IT_GeographicNumber
    {
        ...
        public void Parse_Known_GeographicPhoneNumber_0X_AreaCode(string value, string areaCode, string localNumber, string geographicArea)
        {
            ...
            Assert.Equal(CountryInfo.IT, geographicPhoneNumber.Country);
        ...
        [InlineData("011000", "011", "000", "Turin")]
        [InlineData("0119999999", "011", "9999999", "Turin")]
        ...
        [InlineData("041000", "041", "000", "Venezia")]
        [InlineData("0419999999", "041", "9999999", "Venezia")]
        ...
        [InlineData("081000", "081", "000", "Naples")]
        [InlineData("0819999999", "081", "9999999", "Naples")]
        ...
        [InlineData("047300", "0473", "00", "Bressanone")]
        [InlineData("0473999999", "0473", "999999", "Bressanone")]
        ...
        [InlineData("052200", "0522", "00", "Reggio Emilia")]
        [InlineData("0522999999", "0522", "999999", "Reggio Emilia")]
        ...
        [InlineData("092100", "0921", "00", "Cefalù")]
        [InlineData("0921999999", "0921", "999999", "Cefalù")]
