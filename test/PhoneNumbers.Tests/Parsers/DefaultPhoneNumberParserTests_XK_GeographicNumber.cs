...
public class DefaultPhoneNumberParserTests_XK_GeographicNumber
{
    ...
    [Theory]
    [InlineData("028100000", "28", "100000", "Mitrovica")]
    [InlineData("028999999", "28", "999999", "Mitrovica")]
    [InlineData("029100000", "29", "100000", "Prizreni")]
    ...
    [Theory]
    [InlineData("038000000", "38", "000000", "Prishtina")]
    [InlineData("038999999", "38", "999999", "Prishtina")]
    [InlineData("039100000", "39", "100000", "Peja")]
