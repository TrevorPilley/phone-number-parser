...
public class DefaultPhoneNumberParserTests_XK_GeographicNumber
{
    ...
    [Theory]
    [InlineData("028100000", "28", "200000", "Mitrovica")]
    [InlineData("028999999", "28", "999999", "Mitrovica")]
    [InlineData("029100000", "29", "200000", "Prizreni")]
    ...
    [Theory]
    [InlineData("028000000", "280", "20000", "Gjilani")]
    [InlineData("0280999999", "280", "999999", "Gjilani")]
    [InlineData("029000000", "290", "20000", "Ferizaj")]
    ...
    [Theory]
    [InlineData("038000000", "38", "200000", "Prishtina")]
    [InlineData("038999999", "38", "999999", "Prishtina")]
    [InlineData("039100000", "39", "200000", "Peja")]
    ...
    [Theory]
    [InlineData("039000000", "390", "20000", "Gjakova")]
