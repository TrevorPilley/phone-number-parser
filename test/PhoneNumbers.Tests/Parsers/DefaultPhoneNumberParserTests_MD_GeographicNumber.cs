...
public class DefaultPhoneNumberParserTests_MD_GeographicNumber
{
    ...
    [InlineData("023100000", "231", "00000", "Bălți")]
    [InlineData("023199999", "231", "99999", "Bălți")]
    ...
    [InlineData("024200000", "242", "00000", "Ștefan Vodă")]
    [InlineData("024299999", "242", "99999", "Ștefan Vodă")]
    [InlineData("024300000", "243", "00000", "Căușeni")]
    [InlineData("024399999", "243", "99999", "Căușeni")]
    [InlineData("024400000", "244", "00000", "Călărași")]
    [InlineData("024499999", "244", "99999", "Călărași")]
    ...
    [InlineData("025000000", "250", "00000", "Florești")]
    [InlineData("025099999", "250", "99999", "Florești")]
    [InlineData("025100000", "251", "00000", "Dondușeni")]
    [InlineData("025199999", "251", "99999", "Dondușeni")]
    ...
    [InlineData("029100000", "291", "00000", "Ceadîr-Lunga")]
    [InlineData("029199999", "291", "99999", "Ceadîr-Lunga")]
    [InlineData("029300000", "293", "00000", "Vulcănești")]
    [InlineData("029399999", "293", "99999", "Vulcănești")]
    ...
    [InlineData("034300000", "343", "00000", "Căușeni")]
    [InlineData("034399999", "343", "99999", "Căușeni")]
    [InlineData("034400000", "344", "00000", "Călărași")]
    [InlineData("034499999", "344", "99999", "Călărași")]
    ...
    [InlineData("035000000", "350", "00000", "Florești")]
    [InlineData("035099999", "350", "99999", "Florești")]
    [InlineData("035100000", "351", "00000", "Dondușeni")]
    [InlineData("035199999", "351", "99999", "Dondușeni")]
    ...
    [InlineData("037100000", "371", "00000", "Ocniţa")]
    [InlineData("037199999", "371", "99999", "Ocniţa")]
    ...
    [InlineData("039100000", "391", "00000", "Ceadîr-Lunga")]
    [InlineData("039199999", "391", "99999", "Ceadîr-Lunga")]
    ...
    [Theory]
    [InlineData("053300", "533", "00", "Tiraspol")]
    [InlineData("053399999", "533", "99999", "Tiraspol")]
    [InlineData("055200", "552", "00", "Bender")]
    [InlineData("055299999", "552", "99999", "Bender")]
    [InlineData("055500", "555", "00", "Rîbnița")]
    [InlineData("055599999", "555", "99999", "Rîbnița")]
    [InlineData("055700", "557", "00", "Slobozia")]
