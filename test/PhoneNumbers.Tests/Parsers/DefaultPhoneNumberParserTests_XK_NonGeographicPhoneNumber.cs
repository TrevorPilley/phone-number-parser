...
/// </summary>
public class DefaultPhoneNumberParserTests_XK_NonGeographicPhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.Kosovo);

    [Theory]
    [InlineData("080700000", "807", "00000")]
    [InlineData("080799999", "807", "99999")]
    public void Parse_Known_NonGeographicPhoneNumber_8XX_NationalDestinationCode(string value, string NationalDestinationCode, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.Kosovo, nonGeographicPhoneNumber.Country);
    ...
    [InlineData("090100000", "901", "00000")]
    [InlineData("090199999", "901", "99999")]
    ...
    [Theory]
    [InlineData("080400000", "804", "00000")]
    [InlineData("080499999", "804", "99999")]
