...
public class PhoneNumberParserFactoryTests
{
    ...
    [Fact]
    public void GetParser_For_CountryInfo_Canada_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Canada));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_Denmark_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Denmark));

    [Fact]
    public void GetParser_For_CountryInfo_Egypt_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Egypt));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_Finland_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Finland));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_Hungary_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Hungary));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_Kosovo_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Kosovo));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_Moldova_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.Moldova));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_PapuaNewGuinea_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.PapuaNewGuinea));
    ...
    [Fact]
    public void GetParser_For_CountryInfo_SouthAfrica_Returns_DefaultPhoneNumberParser() =>
        Assert.IsType<DefaultPhoneNumberParser>(_factory.GetParser(CountryInfo.SouthAfrica));
