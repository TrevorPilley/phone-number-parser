...
/// </summary>
public class DefaultPhoneNumberParserTests_MD_NonGeographicPhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.Moldova);

    [Theory]
    [InlineData("080300000", "803", "00000")]
    [InlineData("080399999", "803", "99999")]
    [InlineData("081400000", "814", "00000")]
    [InlineData("081499999", "814", "99999")]
    ...
    public void Parse_Known_NonGeographicPhoneNumber_8XX_NationalDestinationCode(string value, string NationalDestinationCode, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.Moldova, nonGeographicPhoneNumber.Country);
    ...
    [Theory]
    [InlineData("090000000", "900", "00000")]
    [InlineData("090099999", "900", "99999")]
    [InlineData("090500000", "905", "00000")]
    [InlineData("090500000", "905", "00000")]
    [InlineData("090599999", "905", "99999")]
    [InlineData("090599999", "905", "99999")]
    ...
    [Theory]
    [InlineData("080800000", "808", "00000")]
    [InlineData("080899999", "808", "99999")]
