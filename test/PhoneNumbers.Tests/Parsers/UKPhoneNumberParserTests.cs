...
namespace PhoneNumbers.Tests.Parsers
{
    ...
    public partial class UKPhoneNumberParserTests
    {
        ...
        {
            var exception = Assert.Throws<ArgumentException>(() => _parser.Parse("0113111222", CountryInfo.UK));
        ...
        {
            var exception = Assert.Throws<ArgumentException>(() => _parser.Parse("0201112222", CountryInfo.UK));
        ...
        {
            var exception = Assert.Throws<ArgumentException>(() => _parser.Parse("0300111111", CountryInfo.UK));
        ...
        {
            var exception = Assert.Throws<ArgumentException>(() => _parser.Parse("0700012345", CountryInfo.UK));
        ...
        {
            var exception = Assert.Throws<ArgumentException>(() => _parser.Parse(value, CountryInfo.UK));
        ...
        {
            var exception = Assert.Throws<ArgumentException>(() => _parser.Parse("+1111111111", CountryInfo.UK));
        ...
        {
            var exception = Assert.Throws<NotSupportedException>(() => _parser.Parse("0411111111", CountryInfo.UK));
        }
