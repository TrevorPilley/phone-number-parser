...
/// </summary>
public class DefaultPhoneNumberParserTests_QA_NonGeographicPhoneNumber
{
    ...
    public void Parse_Known_NonGeographicPhoneNumber(string value, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.Qatar, nonGeographicPhoneNumber.Country);
    ...
    [Theory]
    [InlineData("2800000000", "2800000000")]
