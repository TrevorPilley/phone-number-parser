...
public class DefaultPhoneNumberParserTests_MX_GeographicNumber
{
    ...
    [Theory]
    [InlineData("2100000000", "2", "100000000", "Este")]
    [InlineData("2999999999", "2", "999999999", "Este")]
    ...
    [Theory]
    [InlineData("3100000000", "3", "100000000", "Oeste")]
    [InlineData("3999999999", "3", "999999999", "Oeste")]
    ...
    [Theory]
    [InlineData("4100000000", "4", "100000000", "Norte")]
    [InlineData("4999999999", "4", "999999999", "Norte")]
    ...
    [Theory]
    [InlineData("5100000000", "5", "100000000", "Central")]
    [InlineData("5999999999", "5", "999999999", "Central")]
    ...
    [Theory]
    [InlineData("6100000000", "6", "100000000", "Noroeste")]
    [InlineData("6999999999", "6", "999999999", "Noroeste")]
    ...
    [Theory]
    [InlineData("7100000000", "7", "100000000", "Sur oeste")]
    [InlineData("7999999999", "7", "999999999", "Sur oeste")]
    ...
    [Theory]
    [InlineData("8100000000", "8", "100000000", "Noreste")]
    [InlineData("8999999999", "8", "999999999", "Noreste")]
    ...
    [Theory]
    [InlineData("9100000000", "9", "100000000", "Sureste")]
    [InlineData("9109999999", "9", "109999999", "Sureste")]
    [InlineData("9129999999", "9", "129999999", "Sureste")]
    [InlineData("9999999999", "9", "999999999", "Sureste")]
