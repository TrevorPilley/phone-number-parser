...
public class DefaultPhoneNumberParserTests_ES_GeographicNumber
{
    ...
    [InlineData("810999999", "81", "0999999", "Madrid")]
    [InlineData("815000000", "81", "5000000", "Madrid")]
    [InlineData("815999999", "81", "5999999", "Madrid")]
    [InlineData("830000000", "83", "0000000", "Barcelona")]
    [InlineData("830999999", "83", "0999999", "Barcelona")]
    ...
    [InlineData("822000000", "822", "000000", "Tenerife")]
    [InlineData("822999999", "822", "999999", "Tenerife")]
    ...
    [InlineData("828000000", "828", "000000", "Las Palmas")]
    [InlineData("828999999", "828", "999999", "Las Palmas")]
    [InlineData("841000000", "841", "000000", "La Rioja")]
    [InlineData("841999999", "841", "999999", "La Rioja")]
    [InlineData("842000000", "842", "000000", "Cantabria")]
    [InlineData("842999999", "842", "999999", "Cantabria")]
    [InlineData("843000000", "843", "000000", "Guipúzcoa / Gipuzkoa")]
    [InlineData("843999999", "843", "999999", "Guipúzcoa / Gipuzkoa")]
    [InlineData("845000000", "845", "000000", "Álava / Araba")]
    [InlineData("845999999", "845", "999999", "Álava / Araba")]
    [InlineData("846000000", "846", "000000", "Vizcaya / Bizkaia")]
    [InlineData("846999999", "846", "999999", "Vizcaya / Bizkaia")]
    ...
    [InlineData("871000000", "871", "000000", "Balears")]
    [InlineData("871999999", "871", "999999", "Balears")]
    [InlineData("872000000", "872", "000000", "Gerona / Girona")]
    [InlineData("872999999", "872", "999999", "Gerona / Girona")]
    [InlineData("873000000", "873", "000000", "Lérida / Lleida")]
    [InlineData("873999999", "873", "999999", "Lérida / Lleida")]
    ...
    [InlineData("938999999", "93", "8999999", "Barcelona")]
    ...
    [InlineData("922000000", "922", "000000", "Tenerife")]
    [InlineData("922999999", "922", "999999", "Tenerife")]
    ...
    [InlineData("928000000", "928", "000000", "Las Palmas")]
    [InlineData("928999999", "928", "999999", "Las Palmas")]
    [InlineData("941000000", "941", "000000", "La Rioja")]
    [InlineData("941999999", "941", "999999", "La Rioja")]
    [InlineData("942000000", "942", "000000", "Cantabria")]
    [InlineData("942999999", "942", "999999", "Cantabria")]
    [InlineData("943000000", "943", "000000", "Guipúzcoa / Gipuzkoa")]
    [InlineData("943999999", "943", "999999", "Guipúzcoa / Gipuzkoa")]
    [InlineData("944000000", "944", "000000", "Vizcaya / Bizkaia")]
    [InlineData("944999999", "944", "999999", "Vizcaya / Bizkaia")]
    [InlineData("945000000", "945", "000000", "Álava / Araba")]
    [InlineData("945999999", "945", "999999", "Álava / Araba")]
    [InlineData("946000000", "946", "000000", "Vizcaya / Bizkaia")]
    [InlineData("946999999", "946", "999999", "Vizcaya / Bizkaia")]
    ...
    [InlineData("971000000", "971", "000000", "Balears")]
    [InlineData("971999999", "971", "999999", "Balears")]
    [InlineData("972000000", "972", "000000", "Gerona / Girona")]
    [InlineData("972999999", "972", "999999", "Gerona / Girona")]
    [InlineData("973000000", "973", "000000", "Lérida / Lleida")]
    [InlineData("973999999", "973", "999999", "Lérida / Lleida")]
