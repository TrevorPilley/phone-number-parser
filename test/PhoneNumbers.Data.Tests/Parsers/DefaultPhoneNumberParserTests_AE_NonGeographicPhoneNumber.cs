...
/// </summary>
public class DefaultPhoneNumberParserTests_AE_NonGeographicPhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.UnitedArabEmirates);

    [Theory]
    [InlineData("0400000000", "400", "000000")]
    [InlineData("0400999999", "400", "999999")]
    public void Parse_Known_NonGeographicPhoneNumber_4XX_NationalDestinationCode(string value, string NationalDestinationCode, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.UnitedArabEmirates, nonGeographicPhoneNumber.Country);
    ...
    [Theory]
    [InlineData("0600000000", "600", "000000")]
    ...
    [Theory]
    [InlineData("080000", "800", "00")]
    [InlineData("0800999999999", "800", "999999999")]
    ...
    [InlineData("0900099999", "900", "099999")]
    [InlineData("0900200000", "900", "200000")]
    [InlineData("0900299999", "900", "299999")]
