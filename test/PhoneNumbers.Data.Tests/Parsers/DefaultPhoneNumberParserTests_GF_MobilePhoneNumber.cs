...
/// </summary>
public class DefaultPhoneNumberParserTests_GF_MobilePhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.FrenchGuiana);

    [Theory]
    [InlineData("0694000000", "694000000")]
    [InlineData("0694999999", "694999999")]
    public void Parse_Known_MobilePhoneNumber(string value, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.FrenchGuiana, mobilePhoneNumber.Country);
