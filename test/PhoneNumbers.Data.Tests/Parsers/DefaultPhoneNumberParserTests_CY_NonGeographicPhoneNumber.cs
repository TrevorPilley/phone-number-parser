...
/// </summary>
public class DefaultPhoneNumberParserTests_CY_NonGeographicPhoneNumber
{
    ...
    public void Parse_Known_NonGeographicPhoneNumber_5X_NationalDestinationCode(string value, string NationalDestinationCode, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.Cyprus, nonGeographicPhoneNumber.Country);
    ...
    [Theory]
    [InlineData("71000000", "71", "000000")]
    [InlineData("71999999", "71", "999999")]
    ...
    [Theory]
    [InlineData("80000000", "80", "000000")]
    [InlineData("80099999", "80", "099999")]
    ...
    [Theory]
    [InlineData("90000000", "90", "000000")]
    [InlineData("90099999", "90", "099999")]
    [InlineData("90900000", "90", "900000")]
    [InlineData("90999999", "90", "999999")]
    ...
    [Theory]
    [InlineData("80100000", "80", "100000")]
    [InlineData("80999999", "80", "999999")]
