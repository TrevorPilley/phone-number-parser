...
/// </summary>
public class DefaultPhoneNumberParserTests_RE_MobilePhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.Reunion);

    [Theory]
    [InlineData("0692000000", "692000000")]
    [InlineData("0693999999", "693999999")]
    public void Parse_Known_MobilePhoneNumber(string value, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.Reunion, mobilePhoneNumber.Country);
