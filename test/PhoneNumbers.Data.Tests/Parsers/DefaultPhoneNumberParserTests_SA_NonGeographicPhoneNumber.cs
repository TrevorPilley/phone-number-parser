...
/// </summary>
public class DefaultPhoneNumberParserTests_SA_NonGeographicPhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.SaudiArabia);

    [Theory]
    [InlineData("081100000000", "811", "00000000")]
    [InlineData("081199999999", "811", "99999999")]
    [InlineData("089100000000", "891", "00000000")]
    [InlineData("089199999999", "891", "99999999")]
    public void Parse_Known_NonGeographicPhoneNumber_8XX_NationalDestinationCode(string value, string NationalDestinationCode, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.SaudiArabia, nonGeographicPhoneNumber.Country);
    ...
    [Theory]
    [InlineData("0925000000", "9250", "00000")]
    [InlineData("0925099999", "9250", "99999")]
    [InlineData("0925900000", "9259", "00000")]
    [InlineData("0925999999", "9259", "99999")]
    public void Parse_Known_NonGeographicPhoneNumber_9XXX_NationalDestinationCode(string value, string NationalDestinationCode, string subscriberNumber)
    {
        var parseResult = s_parser.Parse(value);
        parseResult.ThrowIfFailure();
    ...
    [Theory]
    [InlineData("0830000000000", "830", "000000000")]
    [InlineData("0830999999999", "830", "999999999")]
    ...
    [InlineData("070099999", "700", "99999")]
    ...
    [Theory]
    [InlineData("0920000000", "9200", "00000")]
    [InlineData("0920099999", "9200", "99999")]
    [InlineData("0920900000", "9209", "00000")]
    [InlineData("0920999999", "9209", "99999")]
