...
public class DefaultPhoneNumberParserTests_NL_GeographicNumber
{
    ...
    [InlineData("0117000000", "117", "000000", "Oostburg")]
    [InlineData("0117999999", "117", "999999", "Oostburg")]
    [InlineData("0118000000", "118", "000000", "Middelburg")]
    [InlineData("0118999999", "118", "999999", "Middelburg")]
    [InlineData("0161000000", "161", "000000", "Rijen")]
    [InlineData("0161999999", "161", "999999", "Rijen")]
    ...
    [InlineData("0180000000", "180", "000000", "IJsselsteden")]
    [InlineData("0180999999", "180", "999999", "IJsselsteden")]
    ...
    [Theory]
    [InlineData("0222000000", "222", "000000", "Den Burg")]
    [InlineData("0222999999", "222", "999999", "Den Burg")]
    ...
    [InlineData("0226000000", "226", "000000", "Noord Scharwoude")]
    [InlineData("0226999999", "226", "999999", "Noord Scharwoude")]
    [InlineData("0227000000", "227", "000000", "Middenmeer")]
    [InlineData("0227999999", "227", "999999", "Middenmeer")]
    ...
    [InlineData("0297000000", "297", "000000", "Uithoorn")]
    [InlineData("0297999999", "297", "999999", "Uithoorn")]
    ...
    [InlineData("0318000000", "318", "000000", "Ede")]
    [InlineData("0318999999", "318", "999999", "Ede")]
    ...
    [InlineData("0523000000", "523", "000000", "Dedemsvaart")]
    [InlineData("0523999999", "523", "999999", "Dedemsvaart")]
    ...
    [InlineData("0562000000", "562", "000000", "West Terschelling")]
    [InlineData("0562999999", "562", "999999", "West Terschelling")]
    ...
    [InlineData("0571000000", "571", "000000", "Twello")]
    [InlineData("0571999999", "571", "999999", "Twello")]
    ...
    [InlineData("0598000000", "598", "000000", "Hoogezand")]
    [InlineData("0598999999", "598", "999999", "Hoogezand")]
    ...
    [Theory]
    [InlineData("0700000000", "70", "0000000", "’s-Gravenhage")]
    [InlineData("0709999999", "70", "9999999", "’s-Gravenhage")]
