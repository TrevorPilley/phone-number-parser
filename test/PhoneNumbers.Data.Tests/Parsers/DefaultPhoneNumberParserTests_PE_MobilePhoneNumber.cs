...
/// </summary>
public class DefaultPhoneNumberParserTests_PE_MobilePhoneNumber
{
    private static readonly PhoneNumberParser s_parser = DefaultPhoneNumberParser.Create(CountryInfo.Peru);

    [Theory]
    [InlineData("0900000000", "9", "00000000")]
    [InlineData("0999999999", "9", "99999999")]
    public void Parse_Known_MobilePhoneNumber(string value, string NationalDestinationCode, string subscriberNumber)
    {
        ...
        Assert.Equal(CountryInfo.Peru, mobilePhoneNumber.Country);
